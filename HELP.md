...
* The original package name 'com.doctors-patient-management.application' is invalid and this project uses 'com.doctorspatientmanagement.application' instead.
